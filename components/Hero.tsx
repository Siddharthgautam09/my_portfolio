    ...
    <div className="w-full">
      ...
      <div className="flex justify-center relative my-20 z-10 ">
        <div className="max-w-[89vh] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            words="Hi! I' m Siddharth a Next.js Developer,based in India."
            className="text-center text-[40px] md:text-5xl lg:text-6xl "
          />
          <p className="text-center uppercase md:tracking-wider text-sm md:text-md text-blue-100 lg:text-xl mb-4 mt-4 max-w-90">
            Sharp, simple, seamless
          </p>

          <a href="#about">
            <MagicButton title="Show my Work" icon={null} />
          </a>
        </div>
      </div>
    </div>
